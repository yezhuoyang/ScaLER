...
__all__: list[str] = [
    ...
    "Sampler",
    "compile_QEPG",
    "return_detector_matrix",
    "return_samples",
    "return_samples_Monte_separate_obs_with_QEPG",
    "return_samples_many_weights",
    "return_samples_many_weights_numpy",
...
class QEPGGraph:
    def __init__(
        ...
        num_detector: typing.SupportsInt,
        num_noise: typing.SupportsInt,
    ) -> None: ...
...
def return_samples(
    prog_str: str, weight: typing.SupportsInt, shots: typing.SupportsInt
) -> list[list[bool]]:
    """
    Function that returns samples based on a circuit and parameters
    """

def return_samples_Monte_separate_obs_with_QEPG(
    graph: QEPGGraph, error_rate: typing.SupportsFloat, shot: typing.SupportsInt
...
def return_samples_many_weights(
    prog_str: str,
    weight: collections.abc.Sequence[typing.SupportsInt],
    shots: collections.abc.Sequence[typing.SupportsInt],
) -> list[list[list[bool]]]:
    """
    Function that returns samples of a list of weights based on a circuit and parameters
    """

def return_samples_many_weights_numpy(
    prog_str: str,
    weight: collections.abc.Sequence[typing.SupportsInt],
    shots: collections.abc.Sequence[typing.SupportsInt],
...
def return_samples_many_weights_separate_obs(
    prog_str: str,
    weight: collections.abc.Sequence[typing.SupportsInt],
    shots: collections.abc.Sequence[typing.SupportsInt],
) -> tuple[numpy.typing.NDArray[numpy.bool_], numpy.typing.NDArray[numpy.bool_]]: ...
def return_samples_many_weights_separate_obs_with_QEPG(
    graph: QEPGGraph,
    weight: collections.abc.Sequence[typing.SupportsInt],
    shots: collections.abc.Sequence[typing.SupportsInt],
) -> tuple[numpy.typing.NDArray[numpy.bool_], numpy.typing.NDArray[numpy.bool_]]: ...
def return_samples_numpy(
    prog_str: str, weight: typing.SupportsInt, shots: typing.SupportsInt
...
def return_samples_with_fixed_QEPG(
...
def return_samples_with_noise_vector(
    prog_str: str, weight: typing.SupportsInt, shots: typing.SupportsInt
) -> tuple[list[list[tuple[int, int]]], list[list[bool]]]: ...
